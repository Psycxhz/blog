...
const articleSchema = new Schema({
    ...
    coverUrl:{type:String, default:"/file/cover/cover-613816e2226d6cb229ba787d1631760631952.jpg"},//cover封面地址
    date:{type:Number, default:Date.now()},//发表时间
    readingNum:{type:Number,default:0},//阅读数
    author:{type:Schema.Types.ObjectId, ref:"users", required:true}//发表人（作者）
});
